package org.com.raian.krasamocodechallenge.util
...
class NetworkReceiver(networkListener: NetworkReceiver.NetworkListener) : BroadcastReceiver() {

    private var networkListener: NetworkReceiver.NetworkListener? = networkListener

    //For making this reusable. In this case, it is not required due to I wired it to the Abstract BaseActivity
    fun setNetworkListener(networkListener: NetworkReceiver.NetworkListener) {
